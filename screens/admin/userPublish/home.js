    ...
    return (
      <>
        ...
        <View style={styles.noResultContainer}>
          <ActivityIndicator size="large" color={BOTTOM_TAB_COLORS[3]} />
        </View>
      </>
    )
  }
              ...
              renderItem={({ item }) => {
                return (
                  <Card
                    ...
                    style={[
                      { marginVertical: 3 },
                      item.applicable ? {} : { backgroundColor: '#eee' },
                    ]}
                  >
                    <Card.Title
                      title={item.jobTitle}
...
const styles = StyleSheet.create({
  ...
  buttonContainer: {
    ...
    elevation: 4,
    zIndex: 2,
    backgroundColor: BOTTOM_TAB_COLORS[3],
  },
  buttonIcon: {
    color: '#fff',
    fontSize: 30,
